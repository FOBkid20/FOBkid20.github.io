(function () {
    ...
    var EVENTS = [
        ...
        { id: 'bosewishlist', title: 'Bose Wishlist Feature', displayDate: 'Summer 2019', start: { y: 2019, m: 6 }, end: { y: 2019, m: 8 }, category: 'projects', audience: ['professional'], description: 'Owned a rule-based wishlist classifier identifying product wishlists from unstructured review data using ElasticSearch.', link: { page: 'pages/professional.html', anchor: 'bosewishlist' } },
        { id: 'bosekibana', title: 'Bose Kibana Trainings', displayDate: 'Summer 2019', start: { y: 2019, m: 6 }, end: { y: 2019, m: 8 }, category: 'projects', audience: ['professional'], description: 'Trained cross-functional teams on an internal NLP tool and built Kibana dashboards to clarify its capabilities and direction.', link: { page: 'pages/professional.html', anchor: 'bosekibana' } },
        { id: 'parisabroad', title: 'Study Abroad, Paris', displayDate: 'Fall 2019', start: { y: 2019, m: 9 }, end: { y: 2019, m: 12 }, category: 'education', audience: ['professional', 'personal'], description: 'Studied sociology at the Sorbonne and ballet/pointe at the Marais School of Dance.', link: { page: 'pages/personal.html', anchor: 'studyabroad' } },
        ...
        { id: 'needlefeltpenguin', title: 'Needlefelted Penguin', displayDate: '2024', start: { y: 2024, m: 1 }, category: 'other', audience: ['personal'], description: 'A penguin named Pebbles, felted to kick off 2024.', link: { page: 'pages/personal.html', anchor: 'needlefeltpenguin' } },
        { id: 'yearofdance', title: 'Year of Dance', displayDate: 'Feb – Oct 2024', start: { y: 2024, m: 2 }, end: { y: 2024, m: 10 }, category: 'performing', audience: ['personal'], description: 'Sampled 25 dance styles in depth and 18 more briefly; illness cut the challenge off outside this window.', link: { page: 'pages/personal.html', anchor: 'yearofdance' } },
        ...
        { id: 'cert-datacamp-sql', title: 'Introduction To SQL', displayDate: 'Apr 2026', start: { y: 2026, m: 4 }, category: 'career', audience: ['professional'], description: 'Earned this certification from DataCamp.', link: { page: 'pages/professional.html', anchor: 'cert-datacamp-sql' } },
        { id: 'cert-datacamp-sql-intermediate', title: 'Intermediate SQL', displayDate: 'Aug 2026', start: { y: 2026, m: 8 }, category: 'career', audience: ['professional'], description: 'Earned this certification from DataCamp.', link: { page: 'pages/professional.html', anchor: 'cert-datacamp-sql-intermediate' } },
        { id: 'cert-datacamp-claude-code', title: 'Claude Code in Action', displayDate: 'Aug 2026', start: { y: 2026, m: 8 }, category: 'career', audience: ['professional'], description: 'Earned this certification from DataCamp.', link: { page: 'pages/professional.html', anchor: 'cert-datacamp-claude-code' } },
        ...
        { id: 'imme', title: 'Recorded "I\'m Me"', displayDate: 'Aug 2026', start: { y: 2026, m: 8 }, category: 'performing', audience: ['personal'], description: "Recorded a version of Us the Duo's song \"I'm Me\" customized to my own life.", link: { page: 'pages/personal.html', anchor: 'imme' } },
